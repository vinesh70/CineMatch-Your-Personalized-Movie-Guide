...
def fetch_poster(movie_id):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=fd0384e45f087a35e745ca29d8aef4ae'.format(movie_id))
    data = response.json()
...
def recommend(movie):
    ...
    return recommend_movies,recommanded_movies_posters
